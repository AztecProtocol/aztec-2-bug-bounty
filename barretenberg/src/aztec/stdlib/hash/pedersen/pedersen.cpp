 ...
 *mod p` where p is the circuit modulus.
 *
                                            ...
                                            const bool validate_edge_cases)
{
     ...
     *
     *   ------------------------------------------------------------------------------------------------------------------------------------------------------
     *   | condition               | (p.lo - w.lo + 2^126) >> 126 | status of low limb | does p.lo overlap with p.hi? |
     *condition for w < p            |
     *   ------------------------------------------------------------------------------------------------------------------------------------------------------
     *   | w.lo > p.lo             | 0                            | negative           | yes, p.lo borrows 1 from p.hi
     *| (p.hi - w.hi - 1) must be >= 0 | | w.lo <= p.lo, w.lo >= 0 | 1                            | positive           |
     *no                                  | (p.hi - w.hi) must be >= 0     | | w.lo << 0               | 2 | positive |
     *yes, p.lo carries 1 to p.hi         | (p.hi - w.hi + 1) must be >= 0 |
     *   ------------------------------------------------------------------------------------------------------------------------------------------------------
     **/
